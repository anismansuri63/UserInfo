...
extension UIAlertController {
    ...
    static func alertAfterDelay(WithMessage message: String, andTitle title: String = "Alert") {
    ...
    static func alert(message: String, andSelectionHandler selectionHandler:((Int)->())? = nil) {
        self.showAlert(andMessage: message, andButtonTitles: ["OK"], andSelectionHandler: selectionHandler)
    }
    
    static func showAlert(withTitle title:String = "Alert",andMessage message:String, andButtonTitles aryButtons:[String], andSelectionHandler selectionHandler:((Int)->())?) -> Void{
    ...
    static func showActionSheet(withTitle title:String = "Alert",andMessage message:String, andButtonTitles aryButtons:[String], andCancelButton cancelButtonTitle:String, andSelectionHandler selectionHandler:((Int)->())?) -> Void{
